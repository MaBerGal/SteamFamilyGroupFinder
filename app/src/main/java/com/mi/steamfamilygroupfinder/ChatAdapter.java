    ...
    public class ChatViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(ChatMessage message) {
            ...
            if (message.getSenderId().equals(currentUserId)) {
                ...
                cardViewMessage.setCardElevation(0); // Optional: remove elevation for sent messages
            } else {
                // Message received from another user
                cardViewMessage.setCardBackgroundColor(ContextCompat.getColor(context, R.color.colorReceivedMessage));
                cardViewMessage.setCardElevation(0); // Optional: remove elevation for received messages
            }
        }
    }
}
